      ...
      <div className="max-w-7xl mx-auto"> 
        ...
        <div className="bg-white rounded-[32px] shadow-sm border border-[#94A3B8]/10 overflow-hidden flex flex-col md:flex-row mb-10">
          ...
          <div className="md:w-2/5 p-10 flex flex-col justify-center bg-white">
            ...
            {/* --- DYNAMIC FEATURES (Spaced & Open Layout) --- */}
            ...
            <div className="flex flex-col gap-3">
              <button onClick={buyNowHandler} className="w-full bg-[#0F172A] text-white py-4 rounded-2xl font-bold uppercase tracking-widest hover:bg-[#1E293B]">Buy It Now</button>
                  ...
                  product.reviews.map((rev) => (
                    <div key={rev._id} className="bg-[#F8FAFC] p-6 rounded-2xl border border-[#94A3B8]/10">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 bg-[#0F172A] rounded-full flex items-center justify-center text-white font-bold">{rev.name[0]}</div>
                        <div>
