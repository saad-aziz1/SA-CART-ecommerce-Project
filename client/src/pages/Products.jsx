  ...
  useEffect(() => {
    if (products.length > 0 && cartItems.length > 0) {
      ...
      cartItems.forEach((cartItem) => {
        if (!validProductIds.includes(cartItem.product)) {
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    <button 
                      ...
                      className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all duration-300 shadow-sm active:scale-95 text-white
