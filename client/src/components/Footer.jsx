        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#94A3B8] text-sm font-medium">
              <li><Link to="/products" className="hover:text-[#F59E0B] transition-colors">All Products</Link></li>
              <li><Link to="/categories" className="hover:text-[#F59E0B] transition-colors">Categories</Link></li>
          ...
          {/* Column 4: Newsletter - Using Action Color (#F59E0B) */}
          <div>
